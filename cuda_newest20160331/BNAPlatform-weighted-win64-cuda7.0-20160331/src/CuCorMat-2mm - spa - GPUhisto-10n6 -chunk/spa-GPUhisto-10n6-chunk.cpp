...
/****************************************BOLD file***********************************************/ 
			...
			int GPU_Batch_size = Batch_size * 2; //flag
			int CPU_Batch_size = Batch_size * 1;//flag
			...
			rthresh = CorMat_spa2rth_stream(OutCor, BOLD, N, L, GPU_Batch_size,s_thresh, aggregate);
